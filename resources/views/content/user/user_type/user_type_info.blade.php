      ...
      <div class="card border-primary">
                ...
                <div class="modal-body pb-5 px-sm-5 pt-50">
                  ...
                  <form id="editUserForm" class="row gy-1 pt-75" onsubmit="return false">
                    ...
                    <div class="col-12 col-md-6">
                      <label class="form-label" for="modalEditUserLastName">User Type name</label>
                      <input
                        type="text"
                    ...
                    <div class="col-12 col-md-6">
                      <label class="form-label" for="modalEditUserLastName">User Type name (bn)</label>
                      <input
                        type="text"
                        id="modalEditUserLastName"
                        name="modalEditUserLastName"
        ...
        <div class="card-datatable">
          <table class="datatables-ajax table table-responsive">
            <thead>
              <tr class="text-white">
                <th class="bg-primary">User Type Name</th>
                <th class="bg-primary">User Type Name (bn)</th>
                ...
                <td>
                  <div class="dropdown">
                      ...
                      <div class="dropdown-menu dropdown-menu-end" style="position: absolute; inset: 0px auto auto 0px; margin: 0px; transform: translate(-92px, 16px);" data-popper-placement="bottom-end">
                          <a class="dropdown-item" href="{{url('update_user_type_info/1')}}">
