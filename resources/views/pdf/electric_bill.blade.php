            ...
            <div class="row">
                <table width="100%" cellspacing="0" style="table-layout: fixed; padding: 10px;">
                    ...
                    <tr>
                        <td>বর্তমান একক</td>
                        <td>
                            {{$NumBangla->bnNum($item->current_meter_reading)}}
                            <span style="text-align: right">({{$NumBangla->bnNum(number_format(date('d',strtotime($item->current_meter_reading_date))))}}-{{$NumBangla->bnNum(number_format(date('m',strtotime($item->current_meter_reading_date))))}}-{{$NumBangla->bnNum(date('Y',strtotime($item->current_meter_reading_date)))}} ইং)</span>
                        </td>
                        <td></td>
                        <td></td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            {{$NumBangla->bnNum($item->previous_meter_reading)}}
                            <span style="text-align: right">({{$NumBangla->bnNum(number_format(date('d',strtotime($item->previous_meter_reading_date))))}}-{{$NumBangla->bnNum(number_format(date('m',strtotime($item->previous_meter_reading_date))))}}-{{$NumBangla->bnNum(date('Y',strtotime($item->previous_meter_reading_date)))}} ইং)   </span>
                        </td>
                        <td></td>
                        <td></td>
                    </tr>
