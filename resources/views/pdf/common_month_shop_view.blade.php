...
@section('title', 'Electricity Bill Common by Monthwise')
@section('content')
    <section>
        <div class="row">
            <div class="col-12">
                <form action="{{URL::to('electric_bill_common_month_shop_wise_pdf')}}" enctype="multipart/form-data" target="_blank">
