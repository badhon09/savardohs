...
<div class="navbar-container d-flex content">
    ...
    <ul class="nav navbar-nav">
      <li class="nav-item d-none d-lg-block">
        <a class="nav-link nav-link-style">
          @php
            $revenue = App\Models\Revenue::where('id',Auth::user()->revenue_source_id)->first();
          @endphp
  ...
  <ul class="nav navbar-nav align-items-center ms-auto">
    ...
    @php
      $billing = App\Models\Billing::where('id',Auth::user()->billing_dept_id)->first();
    @endphp
    {{$billing->billing_dept_name}}
    </li>
    <li class="nav-item dropdown dropdown-language">
      ...
      <div class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdown-flag">
          ...
          <a class="dropdown-item" href="{{ url('lang/bd') }}" data-language="bn">
    ...
    <li class="nav-item dropdown dropdown-user">
      ...
      <div class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdown-user">
        <!-- <h6 class="dropdown-header">
          @php
          $auth_user = App\Models\User::where('email',session()->get('email'))->first();
          @endphp
          @if($auth_user->revenue_source_id == 1)          
          <a href="http://localhost/Flat">Switch <i class="me-50" data-feather="arrow-right"></i> Flat</a> 
          @endif
        </h6> -->
        ...
        <h6 class="dropdown-header">
          @php
            $auth_user = App\Models\User::where('email',session()->get('email'))->first();
            $revenue_id = explode(',',$auth_user->revenue_source_id); 
            $menuDT='';         
          @endphp
          @foreach($revenue_id as $id)          
            @if($id == 1)          
              @php
                $menuDT .= '<a href="http://localhost/Flat">Switch <i class="me-50" data-feather="arrow-right"></i> Flat</a><div class="dropdown-divider"></div>'
              @endphp 
            @endif            
          @endforeach
        {!!$menuDT!!}          
        ...
        <a class="dropdown-item"
          href="{{ URL::to('admin-user/admin-user-edit/'.$auth_user->id) }}">
